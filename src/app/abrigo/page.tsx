...
export default function Abrigo(): JSX.Element {
  ...
  const filteredAbrigos = res.filter(
    (abrigo) =>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Animal Adoption - Abrigos Parceiros
              </h1>
              <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Conheça os abrigos parceiros da Animal Adoption que trabalham
                incansavelmente para cuidar e encontrar lares para animais em
            ...
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 text-white text-center">
              ...
              <p className="text-lg mb-6">
                Conhece algum abrigo que deveria estar aqui? Ajude-nos a
                expandir nossa rede de parceiros!
              </p>
              <button
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                {filteredAbrigos.length} abrigo
                {filteredAbrigos.length !== 1 ? "s" : ""} encontrado
                {filteredAbrigos.length !== 1 ? "s" : ""}
              </p>
            </div>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">
                  {searchTerm
                    ...
                    : "Ainda não há abrigos cadastrados"}
                </p>
              </div>
            )}
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="pt-4 border-t border-gray-100">
                        <div className="flex items-center space-x-2 text-xs text-gray-500 mb-1">
                          ...
                          <span>
                            Criado em:{" "}
                            {new Date(abrigo.createdAt).toLocaleDateString(
                              "pt-BR"
                            )}
                          </span>
                        </div>
                        ...
                        <div className="flex items-center space-x-2 text-xs text-gray-500">
                          ...
                          <span>
                            Atualizado em:{" "}
                            {new Date(abrigo.updatedAt).toLocaleDateString(
                              "pt-BR"
                            )}
                          </span>
                        </div>
